...
<div class="contentBox" style="padding:20px;">
	<div class="content">
	    ...
	    <form id="searchForm" action="/auth/updateAuth.do" method="POST">
	    <div class="cnt_box">
	        <div class="cnt_inner">
	            <div class="tbl_scrollbox">
	                <table class="tbl_style1">
	                    <caption>그룹이동 회원리스트</caption>
	                    <colgroup>
                            <col style="width:10%;">
                            <col style="width:40%;">
                            <col style="width:40%;">	                                        
                ...
                <div>
                    <table class="tbl_style1">
                        ...
                        <tbody class="tbl_inner">
                            <tr>
                            	<th style="text-align:center;">현재권한</th>
                            	<td style="text-align:center;">${userList[0].authrtCd}</td>
                                <th style="text-align:center;">이동권한</th>
