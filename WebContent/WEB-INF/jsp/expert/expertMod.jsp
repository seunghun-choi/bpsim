...
<head>
    ...
    function cancleUpdate(){
    	location.href = "expertDetail.do?exprt_mng_no=${expert.exprt_mng_no }${back_params}"
    }
	function updateExpert(){
		dataSettingAll();
		if(checkEsntlData()){ // 필수값 및 데이터 유형 체크
			$("#updateForm").submit();
		}
	}
    ...
    function deleteProfile() {
        ...
        profileImage.src = ''; // 이미지 소스를 빈 값으로 설정 (이미지를 없앰)
...
<body>
	<div class="contentBox">
	    <div class="content">
	        ...
	        <form name="updateForm" id="updateForm" method="post" action="/expert/updateExpertInfo.do" enctype="multipart/form-data">
	        ...
	        <input type="hidden" name="img_file_path_nm" value="${expert.img_file_path_nm }">
	        <input type="hidden" name="img_file_del_yn" id="img_file_del_yn">
	        ...
	        <div class="cnt_box">
	                        ...
	                        <tr>
	                            ...
	                            <td rowspan="6">
	                                <div class="profile_photo">
	                                	<c:if test="${expert.img_file_path_nm ne null }">
	                                		<button type="button" class="btn-icon delete" id="delProFileBtn"onclick="deleteProfile()"><span class="blind">삭제</span><span class="icon_x"></span></button>
	                                	</c:if>
							            <img id="profileImage" src="${expert.img_file_path_nm}" alt="전문가 사진">
							        </div>
							        <input type="file" id="profilePhotoInput" name="profilePhoto" accept="image/*" style="display: none;" onchange="previewImage(event)">
							        <button type="button" class="btn" onclick="document.getElementById('profilePhotoInput').click()">찾아보기</button> 
	                            </td>
	                        </tr>
	                       <tr>
	                        	<th scope="row"><span class="required">생년</span></th>
	                            <td colspan="3">
	                                <input type="number" id="brth_dt" name="brth_dt" min="1900" max="2100" step="1" placeholder="YYYY" value="${expert.brth_dt}" style="width:30%;" oninput="this.value=this.value.slice(0,4)" onblur="checkEmptyInfo()">
	                            </td>
	           ...
	           <div class="cnt_inner">
	            ...
	            <div class="txt_right mgt20">
	                <button type="button" class="btn btn-task-type2" onclick="cancleUpdate()">취소</button>
	                <button type="button" class="btn btn-task-type1" onclick="updateExpert()">저장</button>
	            </div>
	        </div>
	        </form>
	    </div>
