...
<style>
  ...
  .wrap > strong{font-weight: bold;font-size:25px;display:block;padding:26px 0 14px;letter-spacing: -1.25px;color: #27223C;}
...
<body>
  <div class="wrap">
    <img src="/images/common/500error.png" alt="500">  
    <strong>현재 서비스의 상태가 원활하지 않습니다.</strong>
    <span>잘못된 스크립트의 실행 또는 내부서버의 오류로 인해 발생했습니다. </span>
    <span>시스템 관리자에게 문의하시기 바랍니다.</span>
    <div class="btn">
